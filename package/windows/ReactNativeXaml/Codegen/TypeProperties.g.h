...
/*static*/ const PropInfo xamlPropertyMap[] = {
        ...
        { MAKE_KEY("myProperty"), MAKE_GET_DP(winrt::RuntimeComponent1::BlankUserControl, MyPropertyProperty), SetPropValue<int32_t>, ViewManagerPropertyType::Number },
...
void XamlMetadata::PopulateNativeProps(winrt::Windows::Foundation::Collections::IMap<winrt::hstring, ViewManagerPropertyType>& nativeProps) const {
    ...
    nativeProps.Insert(winrt::to_hstring("myProperty"), ViewManagerPropertyType::Number);
