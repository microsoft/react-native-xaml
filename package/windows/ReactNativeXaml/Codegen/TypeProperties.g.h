...
/*static*/ const PropInfo xamlPropertyMap[] = {
        ...
        { MAKE_KEY("style"), MAKE_GET_DP(winrt::Windows::UI::Xaml::Controls::Maps::MapControl, StyleProperty), SetPropValue<winrt::Windows::UI::Xaml::Controls::Maps::MapStyle>, ViewManagerPropertyType::String },
...
void XamlMetadata::PopulateNativeProps(winrt::Windows::Foundation::Collections::IMap<winrt::hstring, ViewManagerPropertyType>& nativeProps) const {
    ...
    nativeProps.Insert(winrt::to_hstring("style"), ViewManagerPropertyType::String);
