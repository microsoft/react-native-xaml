...
");
            ...
            #line 17 "C:\code\react-native-xaml\package\Codegen\TypeEvents.tt"
 foreach (var ns in Events.Select(p => p.DeclaringType.GetNamespace()).Distinct()) { 
            ...
            #line 18 "C:\code\react-native-xaml\package\Codegen\TypeEvents.tt"
            ...
            this.Write(".Input.h>\r\n\r\n/////// Events\r\ntemplate<typename TArgs>\r\nvoid SerializeEventArgs(wi" +
                    ...
                    "der = std::make_shared<XamlObject>(senderAsFE, metadata);\r\n      auto objArgs = " +
                    "std::make_shared<XamlObject>(args, metadata);\r\n      auto obj = std::make_shared" +
                    "<facebook::jsi::Object>(rt);\r\n      obj->setProperty(rt, \"sender\", rt.global().c" +
                    "reateFromHostObject(rt, objSender));\r\n      obj->setProperty(rt, \"args\", rt.glob" +
                    "al().createFromHostObject(rt, objArgs));\r\n\r\n      metadata->JsiDispatchEvent(rt," +
                    " tag, std::string(eventName), obj);\r\n      });\r\n  }\r\n  else {\r\n    XamlUIService" +
                    "::FromContext(eai.context).DispatchEvent(eai.obj.try_as<xaml::FrameworkElement>(" +
                    "), wEN.c_str(),\r\n      [senderAsFE, args](const winrt::Microsoft::ReactNative::I" +
                    "JSValueWriter& evtDataWriter) {\r\n        SerializeEventArgs(evtDataWriter, sende" +
                    "rAsFE, args);\r\n      });\r\n  }\r\n};\r\n\r\n/*static*/ const EventInfo EventInfo::xamlE" +
                    "ventMap[] = {\r\n");
            
            #line 58 "C:\code\react-native-xaml\package\Codegen\TypeEvents.tt"
 foreach (var evt in Events) { 
            ...
            #line 59 "C:\code\react-native-xaml\package\Codegen\TypeEvents.tt"
            ...
            #line 60 "C:\code\react-native-xaml\package\Codegen\TypeEvents.tt"
            ...
            #line 62 "C:\code\react-native-xaml\package\Codegen\TypeEvents.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(evt.GetName()));
            ...
            #line 72 "C:\code\react-native-xaml\package\Codegen\TypeEvents.tt"
 } 
            
            #line default
            #line hidden
            
            #line 73 "C:\code\react-native-xaml\package\Codegen\TypeEvents.tt"
 foreach (var evt in SyntheticEvents) { 
            ...
            #line 75 "C:\code\react-native-xaml\package\Codegen\TypeEvents.tt"
 } 
            ...
            #line 78 "C:\code\react-native-xaml\package\Codegen\TypeEvents.tt"
